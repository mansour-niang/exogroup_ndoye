/**
 * Contrats d'interface vers les systemes externes (registre national des
 * aides sociales, Tresor Public). Le moteur de calcul depend uniquement de
 * ces interfaces, jamais des implementations concretes
